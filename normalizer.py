...
PLACE_ALIASES: dict[str, str] = {
    ...
    "дворец культуры профсоюзов":      "Дворец Профсоюзов",
    ...
    "театр им. я. купалы":         "Театр им. Янки Купалы",
    "театр имени я. купалы":         "Театр им. Янки Купалы",
    "театр им. янки купалы":           "Театр им. Янки Купалы",
    ...
    "новый театр":                    "Новый драматический театр",
    ...
    "дворец культуры железнодорожников": "ДК Железнодорожников",
    ...
    "Национальная библиотека Беларуси":         "Национальная библиотека",
    ...
    "музей-мастерская заира азгура":   "Музей-мастерская Азгура",
    "музей-мастерская азгура":   "Музей-мастерская Азгура",
    "мемориальный музей-мастерская заираазгура": "Музей-мастерская Азгура",
    "музей-мастерская з.и.азгура": "Музей-мастерская Азгура",
    "мемориальный музей-мастерская з.и.азгура": "Музей-мастерская Азгура",
    "мемориальный музей-мастерская азгура": "Музей-мастерская Азгура",

    # Галереи
    "галерея ў":                       "Галерея Ў",
    "художественная галерея михаила савицкого": "Галерея Михаила Савицкого",
    "галерея михаила савицкого": "Галерея Михаила Савицкого",
    "галерея «артхаос»":                "Галерея Артхаос",
    "галерея артхаос":                "Галерея Артхаос",
    "артхаос":                "Галерея Артхаос",
    "xудожественная галерея беларт":    "Беларт",
    "галерея беларт":                   "Беларт",
    "viva kola art":                    "Viva Kola Art",
    "ковчег":                            "КЦ Ковчег",
    "семейный культурный центр Ковчег": "КЦ Ковчег",
    "культурный центр ковчег": "КЦ Ковчег",
    ...
    "стадион динамо минск":          "Национальный олимпийский стадион Динамо",
    "динамо":                 "Национальный олимпийский стадион Динамо",
    "национальный олимпийский стадион": "Национальный олимпийский стадион Динамо",
    "олимпийский стадион":          "Национальный олимпийский стадион Динамо",
    "национальный стадион":             "Национальный футбольный стадион",
    "стадион трактор":                  "Национальный футбольный стадион",
    "национальный футбольный стадион":  "Национальный футбольный стадион",
}
...
def normalize_title(title: str) -> str:
    ...
    norm = re.sub(
        r"^(музыкальный\s+проект|акустический\s+эмбиент|выставка-продажа|"
        r"фестиваль|рок\s+шоу|концертная\s+программа|юбилейный\s+концерт|"
        r"сольный\s+концерт|гала-концерт|праздничный\s+концерт|отчетный\s+концерт|"
        r"эстрадный\s+караоке-спектакль|концерт\s+группы|концерт|спектакль|"
        r"шоу|выступление|группа)\s+",
        "", norm,
    )
    # Убираем в конце
    norm = re.sub(r"\s+(концерт|спектакль|шоу|программа|фестиваль)$", "", norm)

    # Убрасываем год в конце, если он явно служит разграничителем названия
    norm = re.sub(r"\s+2026$", "", norm)

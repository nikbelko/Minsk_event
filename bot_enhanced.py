...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "🔍 **Что я умею:**\n"
        "• Искать по **названию** (например: «Ваня», «Дельфин»)\n"
        "• Искать по **дате** (например: 25.12 или 25.12.2024)\n"
        "• Искать по **описанию** (например: «балет»)\n"
        "• Показывать **сегодня**, **завтра**, **выходные** и **ближайшие** события\n"
        "• **Подписки** 🔔 — получай уведомления о новых событиях\n"
        "• **Добавлять события** 📝 — расскажи всем о своём мероприятии\n\n"
